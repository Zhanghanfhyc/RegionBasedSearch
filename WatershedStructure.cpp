...
WatershedStructure::WatershedStructure(char* pixels, int width, int height) {	// 结构体构造函数
...
WatershedStructure::~WatershedStructure() {	// 释放像素类所占空间
...
int WatershedStructure:: size() { return watershedStructure.size(); }	// 返回像素点总数

WatershedPixel* WatershedStructure::at(int i) { return watershedStructure.at(i); }	// 返回某个像素点
